...
- **extract high-fidelity vehicle trajectories from aerial videos (TGSIM, FHWA)** Developed a deep-learning pipeline (detection → tracking → stabilization → cleaning) that processed  
  ...
  - [code](https://github.com/ylinzhang12/TGSIM-trajectory-pipeline) &nbsp; [pdf](https://journals.sagepub.com/doi/abs/10.1177/03611981241257257) &nbsp; [TGSIM dataset](https://catalog.data.gov/dataset/?q=TGSIM&sort=views_recent+desc) 
